              ...
              ...categories.map((category) {
                ...
                return ListTile(
                  ...
                  onTap: () {
                    ...
                    // TODO: Bạn cần có hàm cập nhật category trong appState
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildGreetingCard("Tết đến xuân về, chúc sức khỏe dồi dào, vạn sự bình an."),
                  const SizedBox(height: 12),
                  _buildGreetingCard("Năm mới chúc gia đình mình luôn tràn đầy tiếng cười và hạnh phúc."),
                ],
              ),
            ),
          )
